pipeline {
    ...
    stages {
        ...
        stage('Check Terraform plan') { 
            ...
            steps {
                sh 'terraform plan -var eks_name=$EKSCLUSTERNAME -var eksnode_name=$EKSNODENAME'
            }
        }
        stage('Apply the terraform code') {
            ...
            steps {
                sh 'terraform apply -var eks_name=$EKSCLUSTERNAME -var eksnode_name=$EKSNODENAME -auto-approve'
            }
        }
        stage('Destroy the Infrastructure created by Terraform'){
            ...
            steps {
                sh 'terraform init'
                sh 'terraform destroy -var eks_name=$EKSCLUSTERNAME -var eksnode_name=$EKSNODENAME -auto-approve'
            }
        }
    }
}
